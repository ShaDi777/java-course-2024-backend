...
import edu.java.domain.jooq.generated.tables.LinkChat.LinkChatPath;
...
public class Chat extends TableImpl<ChatRecord> {
    ...
    public LinkChatPath linkChat() {
        if (_linkChat == null)
            _linkChat = new LinkChatPath(this, null, Keys.LINK_CHAT__LINK_CHAT_CHAT_ID_FKEY.getInverseKey());
